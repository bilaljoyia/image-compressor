...
function Featurepngcompressor() {
    ...
    useEffect(() => {
      const fetchArticles = async () => {
        try {
          const response = await fetch('https://backendimagecompressor.bahrainindustrial.com/api/articles/category/PNG Compressor');
                ...
                <section className="bg-white rounded-lg p-6" key={article._id}>
                  ...
                  <p className="text-black">
                    ...
                    <Link
                      ...
                      to={`/png-imagecompressor/${article._id}`} // Passing article ID
                    >
                      Read More
                    </Link>
                  </p>
...
export default Featurepngcompressor;
